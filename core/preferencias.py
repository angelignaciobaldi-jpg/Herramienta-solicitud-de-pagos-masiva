"""Preferencias del usuario que se recuerdan entre sesiones (clave -> valor/lista).

Pensado para guardar/cargar selecciones que el usuario repite (filtros de
Empresa, tema claro/oscuro, estado de la ventana, etc.). Se guarda como un JSON
en la carpeta escribible de datos (rutas.DATOS)."""
