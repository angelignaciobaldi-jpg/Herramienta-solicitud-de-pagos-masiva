...
# DEBE ser el nombre real del repositorio en GitHub: de aquí sale la URL que
# consulta `releases/latest`. Si no coincide, el updater falla en silencio y
# nadie recibe actualizaciones nunca.
REPO = "Herramienta-solicitud-de-pagos-masiva"
NOMBRE_ASSET = "Instalador_SolicitudesPago.exe"
